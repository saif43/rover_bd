...
<html>
                ...
                <nav id="navbar_body" class="navbar navbar-inverse navbar-fixed-top">
                  ...
                  <div style="float: right; margin-right: 5%;">
                    <ul class="nav navbar-nav">
                      ...
                      <li>
                        ...
                        <a id="navbar_option_logout" style="cursor:pointer;" class="dropdown-toggle" type="button" data-toggle="dropdown"><?php echo $username; ?> &#9679;</a>
                        <ul class="dropdown-menu">
                            <form align="center" action="index1.php" method="POST">
                                <li><button style="background:transparent;outline:none;border:none;color:white;transition:all 500ms ease;" name="view_profile_button" id="view_profile_button" >View Profile</button></li>
                                <li class="divider"></li>
                  ...
                  <div style="float:left" align="center" class="collapse" id="features">
                    <ul style="margin-left:280px;" class="nav navbar-nav">
                      ...
                      <li><a class="nav_a" id="navbar_option" href="travel_tracker/travel_tracker.php">Travel Tracker</a><span class="hover"></span></li>
                      <li><a class="nav_a" id="navbar_option" href="explore_yourself/explore_yourself.php">Explore Yourself</a><span class="hover"></span></li>
                    </ul>  
                  </div>
                  </div>
                </nav>
                ...
                <div class="video-container">
                    ...
                    <div id="location_form-main">
                      <div id="location_form-div">
                        <form class="form" id="location_form1">
                            <div align="center">
                                <h1 id="location_header" style="color: #fff;margin-top: -2%;">Location Search</h1>
                                <div>
                                    <span id="location_search" class="input input--shoko">
                                        <input class="input__field input__field--shoko" type="text" id="input-4" placeholder="Type Location Name">
                                ...
                                <form method="post" action="index.php">
                                    <div>
                                        <span id="hotel_finder_hotel_search" class="input input--shoko">
                                            <input class="input__field input__field--shoko" type="text" name="hotel" id="hotel" placeholder="Search By Hotel Name">
                                            <svg class="graphic graphic--shoko" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
                                                <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
                                                <path d="M0,2.5c0,0,298.666,0,399.333,0C448.336,2.5,513.994,13,597,13c77.327,0,135-10.5,200.999-10.5c95.996,0,402.001,0,402.001,0"/>
                                            </svg>
                                        ...
                                        <span id="hotel_finder_location_search" class="input input--shoko">
                                            <input class="input__field input__field--shoko" type="text" name="location" id="location" placeholder="Search By Location">
                                            <svg class="graphic graphic--shoko" width="300%" height="100%" viewBox="0 0 1200 60" preserveAspectRatio="none">
                                                <path d="M0,56.5c0,0,298.666,0,399.333,0C448.336,56.5,513.994,46,597,46c77.327,0,135,10.5,200.999,10.5c95.996,0,402.001,0,402.001,0"/>
                                                <path d="M0,2.5c0,0,298.666,0,399.333,0C448.336,2.5,513.994,13,597,13c77.327,0,135-10.5,200.999-10.5c95.996,0,402.001,0,402.001,0"/>
                                            </svg>
    ...
    <div id="search">
        ...
        <form action="index.php" method="POST">
            <input type="search" id="location1" placeholder="Type Keywords Here..." autocomplete="off"/>
